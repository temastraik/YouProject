    ...
    <?php else: ?>
        ...
        <div class="block_1">
            ...
            <div class="container_tasks">
                <img src="Image/primer_2.png" alt="Пример интерфейса просмотра задачи" title="Создание задачи">
            </div>
        </div>
        ...
        <div class="block_1">
            ...
            <img src="Image/primer_6.png" alt="Пример интерфейса управления командой" title="Управление командой">
        </div>
